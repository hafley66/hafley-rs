...
## Acceptance Criteria
- [x] tests/137_kotlin_receiver_legs.rs: field, ctor-return, typed param, generic-bound, this legs bind with origin receiver
- [x] shadowed local (param or val named like a corpus fn) declines with drop reason inferred, without reading the df plane
- [x] full crate gate green
