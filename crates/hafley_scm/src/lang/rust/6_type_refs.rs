//! Named Rust type references under annotations and generic arguments.
...
use super::call_metadata_rows::path_name;

/// Named references under `ty`, de-duplicated and sorted for stable rows.
pub fn type_refs(ty: &Type) -> Vec<String> {
    let mut out = Vec::new();
...
pub fn collect_path_args(path: &Path, out: &mut Vec<String>) {
