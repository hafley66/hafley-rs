...
//! (shape, family, rows, seams, source) are `pub use crate::read::types::*` re-export
//! shims so historical import paths (`crate::read::shape::Span`, `crate::read::family::TypeF`,
...
pub fn content_id_of(content: &[u8]) -> ContentId {
    ...
    let span = crate::read::trace::phase_span("-", crate::read::trace::Phase::Hash);
    let _entered = span.enter();
    let id = ContentId::blake3(content);
    crate::read::trace::record_phase(&span, content.len() as u64, 0, 1);
    id
}
...
impl TsiNames {
    ...
    pub fn new(lang: &'static str) -> Self {
        Self {
            sink: crate::read::tsi::TsiSink::new(0, crate::read::tsi::Method::Parse),
    ...
    pub fn name(&mut self, id: u32, text: &str) {
        self.sink.fact(
            "tsi.name",
            vec![
                crate::read::tsi::Arg::Id(id),
                crate::read::tsi::Arg::Text(text.to_string()),
            ],
        );
    }
    ...
    pub fn anonymous(&mut self, span: Span) -> u32 {
        ...
        self.sink.fact(
            ...
            vec![
                crate::read::tsi::Arg::Id(id),
                crate::read::tsi::Arg::Atom(self.lang.to_string()),
                span_arg(span),
            ],
        );
        id
    ...
    pub fn fact(&mut self, relation: &'static str, args: Vec<crate::read::tsi::Arg>) {
    ...
    pub fn edge(&mut self, owner: u32, label: &str, target: u32, position: i64) -> u32 {
        ...
        self.fact(
            "tsi.edge",
            vec![
                crate::read::tsi::Arg::Id(edge),
                crate::read::tsi::Arg::Id(owner),
                crate::read::tsi::Arg::Text(label.to_string()),
                crate::read::tsi::Arg::Id(target),
                crate::read::tsi::Arg::Int(position),
            ],
        );
        edge
    }
    ...
    pub fn into_facts(self) -> Vec<crate::read::tsi::FactOut> {
        self.sink
            .rows()
            .into_iter()
...
pub fn span_arg(span: Span) -> crate::read::tsi::Arg {
    crate::read::tsi::Arg::Span(String::new(), span.start, span.end())
}
...
/// what `crate::read::deps` resolves to a file path. The gap was real, not stylistic
...
/// The only per-language input is the `kind_role` table in `crate::read::cfg`.
#[derive(Default, Copy, Clone, Debug)]
pub struct CfgF;
...
impl ResolutionOrigin {
    ...
    pub fn method(self) -> crate::read::tsi::types::Method {
        use crate::read::tsi::types::Method;
        match self {
...
// lives in `crate::read::scip`; only types + the seam trait live here.
...
/// (the ratchet / the engine). `crate::read::scip::byte_range` is that bridge.
///
...
pub struct ScipDocument {
    ...
    pub text: String,
    /// The occurrence span table (`crate::read::scip::DocSpans`): the byte span of
    ...
    pub spans: std::sync::OnceLock<crate::read::scip::DocSpans>,
}
