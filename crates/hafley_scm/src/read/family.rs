//! S2 family model. Canonical definitions now live in `crate::read::types`; this
//! module is a re-export so `crate::read::family::*` import paths keep resolving.
