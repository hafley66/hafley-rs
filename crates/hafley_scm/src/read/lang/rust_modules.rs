...
impl CargoManifest {
    pub fn parse(text: &str) -> Option<CargoManifest> {
    ...
    pub fn explicit_lib_path(&self) -> Option<String> {
...
impl RustModuleIndex {
    ...
    pub fn is_impl_known(&self, name: &str) -> bool {
