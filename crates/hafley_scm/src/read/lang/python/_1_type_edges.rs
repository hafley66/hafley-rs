//! The python syntax tier's TSI rows under `--witness --kinds type`: the
...
pub(super) fn tsi_rows(
    ...
    let span = crate::read::trace::phase_span("python", crate::read::trace::Phase::TsiSyntax);
