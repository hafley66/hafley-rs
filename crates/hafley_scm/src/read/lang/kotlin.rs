...
pub const KOTLIN_SCM: &str = include_str!("../../../../sprefa-extract/queries/kotlin/scip.scm");
...
pub fn kt_header_facts_from_arena(
    src: &[u8],
    query: &hafley_scm::QueryExt,
    arena: &hafley_scm::MatchArena,
    strings: &mut Strings,
...
pub fn def_span(child: tree_sitter::Node) -> Span {
