...
use crate::read::family::CallF;
use crate::read::rows::FamilyBundle;
use crate::read::shape::{ContentId, Span, Strings};
use crate::read::types::{MethodOwner, ReceiverBinding, ReceiverOutcome};
...
impl KtBindPlan {
    ...
    pub fn field_type_of(&self, owner: &str, member: &str) -> Option<&str> {
        self.fields
