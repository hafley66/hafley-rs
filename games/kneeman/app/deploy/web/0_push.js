...
(() => {
  ...
  async function enable() {
    ...
    try {
      ...
      const profile = window.SMASH_WEB_PROFILE;
      const reg = await navigator.serviceWorker.register(`${profile.basePath}sw.js`, { scope: profile.scope });
  ...
  navigator.serviceWorker.getRegistration(window.SMASH_WEB_PROFILE.scope).then(async (reg) => {
