...
| A1 | Queued | One app package at `smash/`, shared first-party packages directly at `crates/`. Move existing code, update consumers/pins, preserve proofs; app runs existing slice. Report exact move/dependency diff before changing packages. |
