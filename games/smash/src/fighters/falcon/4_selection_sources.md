# Falcon selection sources: seven retained clips
...
`movement::pose_for_phase` (`games/smash/src/fighters/falcon/1c_movement.rs:43`)
...
- `p_ftCommonData->x34`, `x78`, `x90`, `x94` are unnamed floats in the shared
  ...
  entries for them (`games/smash/src/fighters/falcon/generated/1_attributes.rs`,
