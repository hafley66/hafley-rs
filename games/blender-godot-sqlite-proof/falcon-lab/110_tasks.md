...
| F4 | Active | Headless Godot controls passed, `.workflow/test-wAVpc6/receipt.json`. Remaining: actual browser dash/run poses, facing, speed and inspected MP4. Preserve historical knee proof. |
| F5 | Pending | Source-bound `just prove`, scoped commit and `just deploy`; production acceptance passes and protected `/game/` hashes remain unchanged. |
