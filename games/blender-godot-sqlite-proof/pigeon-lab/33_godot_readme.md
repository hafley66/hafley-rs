...
Nine Pigeon tests and eight core tests pass. Clippy passes for all Pigeon targets
...
Pigeon package. Pin: `godot = 0.4.5`, minimal code generation, `api-4-5`.
...
scripted Pigeon movement. It does not add full skinning, asset import, production
