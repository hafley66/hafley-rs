...
use pigeon::{Action, Simulation, Snapshot, World};
...
impl PigeonSql {
    #[func]
    fn proof_version(&self) -> GString { "pigeon-sql-gdext-1".into() }
    ...
    #[func]
    #[tracing::instrument(target = "pigeon::web", level = "trace", skip_all)]
