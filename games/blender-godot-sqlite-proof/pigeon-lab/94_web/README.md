...
checks and rsync/SSH commands. Pigeon adds its asset bake, application entry point,
...
Brawl decoding and asset extraction run only in `pigeon-web-bake`, before export.
