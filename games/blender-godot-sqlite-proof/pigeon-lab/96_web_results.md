...
```text
/var/folders/z2/cwfm40fn65n176q8m227wl0r0000gn/T/pigeon-browser-eA9ZLG/receipt.json
/var/folders/z2/cwfm40fn65n176q8m227wl0r0000gn/T/pigeon-browser-eA9ZLG/proof.mp4
```

MP4: 12.76 seconds, 557167 bytes. Temporary artifacts can be reclaimed by the OS.
Publication log: `/private/tmp/pigeon-web-publish.log`.
