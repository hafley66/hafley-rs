...
const CONTROL_ACTION_LABELS = "IDLE|JUMP|FAIR|JUMP SQUAT|FALL|FAIR LANDING|HEAVY LANDING|WALK SLOW|WALK|WALK FAST|DASH|RUN|BRAKE|TURN|RUN TURN|BACK JUMP|AIR JUMP|LIGHT LANDING"
