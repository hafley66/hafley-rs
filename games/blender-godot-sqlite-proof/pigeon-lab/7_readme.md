# PM Pigeon knee, native Rust/wgpu fixture

Run from any directory with:

```sh
bash /Users/chrishafley/projects/hafley-rs/games/blender-godot-sqlite-proof/pigeon-lab/3_run.sh
```
...
`5_pigeon_knee.mp4` shows 180 simulated ticks at 60 Hz, then repeats the same trace
...
`../fixtures/pigeon` contains the downloaded Rukai Data PM 3.6 pages and source
...
GPU capture asserts colored Pigeon and target pixels within geometry regions on
