...
CPU-only verification: `cargo run -j 2 --locked --offline --bin pigeon-rollback -- --sql --verify-only`.
...
All eight Pigeon tests and eight core tests pass; Pigeon Clippy passes with
...
The inherited PM pose/contact, Melee-derived knockback, scripted Pigeon travel,
