//! Lab-local debug observer for the live Pigeon locomotion phase.
//!
...
pub const PHASE_NAMES: [&str; 14] = [
    "IDLE", "WALK", "DASH", "RUN", "BRAKE", "TURN", "SQUAT", "CROUCH_ENTER", "CROUCH_HOLD",
    "CROUCH_EXIT", "LANDING", "JUMP", "FALL", "AIRJUMP",
];
...
mod tests {
    ...
    fn repeated_tick_and_invalid_codes_cannot_create_edges() {
        for invalid in [-1.0, 14.0, 0.5, f64::NAN, f64::INFINITY] {
            let mut dbg = PhaseDebug::new();
            dbg.observe(10, IDLE, 1.0);
            dbg.observe(11, DASH, 1.0);
