# PM Pigeon lifecycle import coverage

Source: Rukaidata PM3.6 Private Pigeon, retrieved 2026-09-08. Exact HTML bytes are
pinned in `../fixtures/pigeon/10_lifecycle_sources.json`. `just import-check`
...
Log: `/private/tmp/pigeon-lifecycle-publish.log`.
