...
#[gdextension]
unsafe impl ExtensionLibrary for PigeonExtension {}
...
impl PigeonSql {
    ...
    #[func]
    #[tracing::instrument(target = "pigeon::godot", level = "trace", skip_all)]
    ...
    #[func]
    #[tracing::instrument(target = "pigeon::godot", level = "trace", skip_all, fields(consume))]
    ...
    fn next_frame(&mut self) -> VarDictionary {
        self.advance(i64::from(pigeon::fixture_input(
    ...
    #[tracing::instrument(target = "pigeon::godot", level = "trace", skip_all, fields(rows = packet.rows.len() / 27, lines = packet.lines.len()))]
