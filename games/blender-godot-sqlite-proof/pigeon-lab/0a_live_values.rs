...
use pigeon::{World, sandbag::Phase};
...
pub fn motion_phase_code(phase: MotionPhase) -> f64 {
    match phase {
        ...
        MotionPhase::Squat => 6.0, MotionPhase::CrouchEnter => 7.0,
        MotionPhase::CrouchHold => 8.0, MotionPhase::CrouchExit => 9.0,
        MotionPhase::Landing => 10.0, MotionPhase::Jump => 11.0,
        MotionPhase::Fall => 12.0, MotionPhase::AirJump => 13.0,
    }
}
