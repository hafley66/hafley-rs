# Pigeon lab: browser, behavior import, and photo characters

Recorded 2026-09-08. User-approved direction; unchecked work remains unimplemented.

## Destination and protection

- Publish **this Pigeon demo/work** at `https://hafley.codes/game3/`.
...
- First bounded dependency closure: Pigeon idle, jump squat, jump, forward air,
...
- `https://github.com/doldecomp/melee/blob/master/src/melee/ft/chara/ftCaptain/ftCa_Init.c`
  exposes Pigeon's motion-state callback table. Pin a revision before importing.
...
- [x] Pure simulation compile check for `wasm32-unknown-unknown` passed on 2026-09-08,
  ...
  `/private/tmp/pigeon-core-wasm-check.log`. This is compilation only.
...
- [ ] Pin and inventory Pigeon's jump/fair/landing behavior dependency closure;
