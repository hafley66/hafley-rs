...
- `jump_plus_attack_autohops_into_an_aerial`: simultaneous jump/attack survives
  ...
  buffering scenario; Pigeon's first adapter only has fair and does not inherit
...
| Pigeon authored TSP and consumers | After skill-guided schema inspection, declare required policy/inspection IO once and regenerate; exact schema file diff remains part of implementation preparation. |
...
First Pigeon acceptance: press attack during jump squat; pending aerial survives
